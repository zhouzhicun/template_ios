...
+ (instancetype)nameItemWithNormal:(NSString *)normal High:(NSString *)high Selected:(NSString *)selected Disable:(NSString *)disable;

+ (instancetype)imageItemWithNormal:(UIImage *)normal High:(UIImage *)high Selected:(UIImage *)selected Disable:(UIImage *)disable;
