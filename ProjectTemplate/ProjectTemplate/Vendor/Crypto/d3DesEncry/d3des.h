...
extern void deskey(unsigned char *, int);/*把short改为int类型，修复警告，许云辉修改*/
/*		      hexkey[8]     MODE
...
extern void des2key(unsigned char *, int);/*把short改为int类型，修复警告，许云辉修改*/
/*		      hexkey[16]     MODE
...
extern void des3key(unsigned char *, int);/*把short改为int类型，修复警告，许云辉修改*/
/*		      hexkey[24]     MODE
 * Sets the internal key registerS according to the hexadecimal
